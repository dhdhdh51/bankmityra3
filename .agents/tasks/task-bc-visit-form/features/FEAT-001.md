...
## Files to Create
1. app/Controllers/Admin/BcVisitController.php
2. app/Models/BcVisit.php
3. views/bc/visit/form.php
4. views/bc/visit/index.php

## Files to Modify
1. app/routes/web.php - Add routes
2. views/layouts/app.php - Add nav link
