    ...
    private function payload(Request $request): array
    {
        ...
        if ($request->hasFile('photo')) {
            ...
            if ($file !== null && $file->isValid()) {
                ...
                $uploadDir = storage_path('uploads/bc-visits');
                if (!is_dir($uploadDir)) {
                    mkdir($uploadDir, 0755, true);
                }

                // Generate unique filename
                $filename = uniqid('visit_', true) . '.' . $file->getClientOriginalExtension();
        ...
        return [
            ...
            'latitude' => $request->nullableStr('latitude'),
            'longitude' => $request->nullableStr('longitude'),
