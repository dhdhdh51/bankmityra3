            ...
            <div class="lrms-card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <p class="form-value"><?= $visit['latitude'] ? e((string) $visit['latitude']) : '—' ?></p>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Longitude</label>
                        <p class="form-value"><?= $visit['longitude'] ? e((string) $visit['longitude']) : '—' ?></p>
                    </div>
                    <?php if ($visit['latitude'] && $visit['longitude']): ?>
                        <div class="col-12">
                            <label class="form-label">Map Link</label>
                            <p class="form-value">
                                <a href="https://maps.google.com/?q=<?= (float) $visit['latitude'] ?>,<?= (float) $visit['longitude'] ?>" 
                    ...
                    <?php if ($visit['photo_path']): ?>
                        <div class="col-12">
                            <label class="form-label">Visit Photo</label>
                            <div>
                                <img src="<?= e(url('/uploads/bc-visits/' . basename((string) $visit['photo_path']))) ?>" 
                                     alt="Visit photo" class="img-thumbnail" style="max-width: 300px; max-height: 300px;">
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="col-12">
